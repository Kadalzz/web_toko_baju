    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-800 via-gray-700 to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
        <div className="flex flex-col md:flex-row">
          {/* Left Side - Hero */}
          <div className="md:w-1/2 bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 p-12 flex flex-col justify-between relative overflow-hidden">
            <div>
            ...
            {/* Decorative Elements */}
            <div className="absolute bottom-0 right-0 w-64 h-64 bg-purple-500/20 rounded-full -mr-32 -mb-32"></div>
            <div className="absolute top-1/2 right-0 w-48 h-48 bg-indigo-500/20 rounded-full -mr-24"></div>
          </div>
            ...
            <div className="max-w-md mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {!isLogin && (
                  <div className="flex items-start">
                    ...
                    <label htmlFor="agreeToTerms" className="ml-2 text-sm text-gray-400">
                      I agree to the{' '}
                      <Link to="/syarat-ketentuan" className="text-purple-400 hover:text-purple-300">
                        Terms & Conditions
                      </Link>
                    </label>
                  </div>
                ...
                <button
                  ...
                  className="w-full py-3 bg-gray-700 hover:bg-gray-600 border border-gray-600 text-white font-medium rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
