          ...
          <div className="lg:py-4">
            ...
            <div className="flex gap-3 mb-8">
              ...
              <button
                ...
                className={`p-3.5 rounded-lg border-2 transition-all duration-300 transform hover:scale-105 ${
                  isWishlisted
                    ? 'bg-red-50 border-red-500 text-red-500 shadow-md'
                    : 'border-accent hover:border-red-400 hover:bg-red-50 hover:text-red-500'
                }`}
              >
                <Heart className={`h-5 w-5 transition-all duration-300 ${
                  isWishlisted ? 'fill-current' : 'hover:fill-red-400'
                }`} />
              </button>
