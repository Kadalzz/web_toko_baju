      ...
      <div className="container">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="heading-2 mb-4">Syarat dan Ketentuan Alba Ganti Baju</h1>
            ...
            <div className="bg-white rounded-lg shadow-card p-8">
              <section className="mb-8">
                ...
                <p className="text-gray-600 mb-4">
                  Dengan menggunakan layanan Alba Ganti Baju, Anda menyetujui syarat dan ketentuan ini. Mohon baca dengan seksama sebelum menggunakan layanan kami.
                </p>
              </section>
